...
class App extends React.Component {
    componentDidMount () {
        ...
        this.refs.jqxNavigationBar.on('collapsedItem', (event) => {
        ...
        return (
               <div>
                ...
                <JqxNavigationBar ref='jqxNavigationBar' style={{ float: 'left' }}
                    template={innerHtml}
                    width={400} height={430} expandMode={'singleFitHeight'} />

                <div style={{ marginLeft: 20, fontStyle: 12, fontFamily: 'Verdana, Geneva, DejaVu Sans, sans-serif', marginTop: 50, float: 'left' }}>
                    <span>Events:</span>
