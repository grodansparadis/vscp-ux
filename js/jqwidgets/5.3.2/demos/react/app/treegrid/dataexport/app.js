...
class App extends React.Component {
    componentDidMount() {
        ...
        this.refs.excelExport.on('click', () => {
            this.refs.myTreeGrid.exportData('xls');
        });
        this.refs.xmlExport.on('click', () => {
            this.refs.myTreeGrid.exportData('xml');
        });
        this.refs.csvExport.on('click', () => {
            this.refs.myTreeGrid.exportData('csv');
        });
        this.refs.tsvExport.on('click', () => {
            this.refs.myTreeGrid.exportData('tsv');
        });
        this.refs.htmlExport.on('click', () => {
            this.refs.myTreeGrid.exportData('html');
        });
        this.refs.jsonExport.on('click', () => {
            this.refs.myTreeGrid.exportData('json');
        });
        this.refs.pdfExport.on('click', () => {
            this.refs.myTreeGrid.exportData('pdf');
        });
    }
    render () {
