...
class App extends React.Component {
    componentDidMount() {
        ...
        this.refs.Remove.on('click', () => {
            let selectedItem = this.refs.myTabs.selectedItem();
            var disabledItems = this.refs.myTabs.getDisabledTabsCount();
            var items = this.refs.myTabs.length();
    ...
    render () {
        ...
        `;
        let styleMargin = { marginTop: '10px' };
        let width = 100;
        return (
            <div>
                ...
                <div style={{ marginLeft: 60, float: 'left' }}>
                    <div style={styleMargin}>
                        <JqxButton ref='Add' width={width} value="Add" />
                    </div>
                    <div style={styleMargin}>
                        <JqxButton ref='Remove' width={width} value="Remove" />
                    </div>
                    <div style={styleMargin}>
                        <JqxButton ref='Disable' width={width} value="Disable" />
                    </div>
                    <div style={styleMargin}>
                        <JqxButton ref='Enable' width={width} value="Enable" />
                    </div>
                    <div style={styleMargin}>
                        <JqxButton ref='EnableAll' width={width} value="Enable All" />
                    </div>
                    <div style={styleMargin}>
                        <JqxButton ref='DisableAll' width={width} value="Disable All" />
                    </div>
                </div>
