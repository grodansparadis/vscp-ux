...
class App extends React.Component {
    componentDidMount() {
        this.refs.rightButton.on('checked', (event) => {
            this.refs.myTabs.scrollPosition('right');
        });

        this.refs.bothButton.on('checked', (event) => {
            this.refs.myTabs.scrollPosition('both');
        });

        this.refs.leftButton.on('checked', (event) => {
        ...
        return (
            <div>
                ...
                <div style={{ float: 'left', marginLeft: 50 }}>
                    <div style={{ marginTop: 10, marginBottom: 10 }}><b>Scroll Buttons Position:</b></div>
                    <JqxRadioButton ref='leftButton' value='Left' height={height} width={width} />
                    <JqxRadioButton ref='rightButton' value='Right' height={height} width={width} checked={true} />
                    <JqxRadioButton ref='bothButton' value='Both' height={height} width={width} />
                </div>
            </div>
        )
    }
