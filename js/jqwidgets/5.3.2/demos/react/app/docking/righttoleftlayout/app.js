...
class Tabs extends React.Component {
    render() {
        return (
            <JqxTabs width={375} height={181} selectedItem={1} rtl={true}>
...
class Panel extends React.Component {
    render() {
        return (
            <JqxPanel width={375} height={180} rtl={true}>
    ...
    render() {
        ...
        return (
            <JqxDocking ref='Docking'
                width={700} orientation={'horizontal'} mode={'docked'} rtl={true}
            >
                <div>
                    <div id='window1' style={{ height: 220 }}>
                        <div>Date and Time</div>
                        <div style={{ overflow: 'hidden' }}>
                            <JqxCalendar width={180} height={180} style={{ float: 'left', marginRight: 10 }} rtl={true} />
                ...
                <div>
                    ...
                    <div id='window4' style={{ height: 220 }}>
                        <div>E-mail</div>
                        <div style={{ overflow: 'hidden' }}>
                            <JqxListBox source={listBoxSource} width={375} height={181} rtl={true} />
                        </div>
                    </div>
                </div>
            </JqxDocking>
