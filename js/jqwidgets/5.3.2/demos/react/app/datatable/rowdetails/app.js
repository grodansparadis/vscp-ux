    ...
    render() {
        ...
        let initRowDetails = (id, row, element, rowinfo) => {
            ...
            if (tabsdiv != null) {
                ...
                let imgurl = '../../images/' + row.firstname.toLowerCase() + '.png';
                ...
                let notescontainer = $('<div style="white-space: normal; margin: 5px;"><span>' + row.notes + '</span></div>');
        ...
        return (
            <JqxDataTable ref='myDataTable'
                width={850} source={dataAdapter} rowDetails={true}
