...
class App extends React.Component {
    ...
    render () {
        ...
        return (
                      <JqxExpander style={{ float: 'right', direction: 'rtl' }} rtl={true} width={300} showArrow={false} toggleMode={'none'}>
                                  ...
                                  <form id='form' action="./">
                                      <table className="register-table">
                                        <tbody>
                                          ...
                                          <tr>
                                              <td>Birth date:</td>
                                              <td><JqxDateTimeInput ref='dateTimeInput' rtl={true} width={156} height={22} value={new Date(2014, 4, 1)} className="birthInput"/></td>
                                          </tr>
                                          <tr>
                                              <td>E-mail:</td>
                                          ...
                                          <tr>
                                              <td>SSN:</td>
                                              <td><JqxMaskedInput rtl={true} width={156} height={22} mask={'###-##-####'} className="ssnInput"/></td>
                                          </tr>
                                          <tr>
                                              <td>Phone:</td>
                                              <td><JqxMaskedInput  rtl={true} width={156} height={22} mask={'(###)###-####'} className="phoneInput"/></td>
                                          </tr>
                                          <tr>
                                              <td>Zip code:</td>
                                              <td><JqxMaskedInput  rtl={true} width={156} height={22} mask={'###-##-####'} className="zipInput"/></td>
                                          </tr>
                                          <tr>
                                              <td colSpan="2" style={{ paddingRight: 70, paddingTop: 10, paddingBottom: 10 }}>
                                              <JqxCheckBox rtl={true} width={130} className="acceptCheckBox" value='I accept terms'/>
                                          </td>
                                      </tr>
                                      <tr>
                                          <td colSpan="2" style={{textAlign: 'center', paddingRight: 100 }}>
