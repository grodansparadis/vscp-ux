...
class App extends React.Component {
    componentDidMount() {
        this.refs.nearButton.on('checked', () => {
            this.refs.myRibbon.scrollPosition('near');
        });

        this.refs.bothButton.on('checked', () => {
            this.refs.myRibbon.scrollPosition('both');
        });

        this.refs.farButton.on('checked', () => {
    ...
    render() {
        return (
            <div>
                ...
                <div style={{ width: 200, float: 'left', marginLeft: 30 }}>
                    <div>
                        <b>Scroll Buttons Position:</b>
                    </div>
                    <JqxRadioButton ref='nearButton'
                        width={100} height={25}>
                        Near
                    </JqxRadioButton>
                    <JqxRadioButton ref='farButton'
                        width={100} height={25}>
                        Far
                    </JqxRadioButton>
                    <JqxRadioButton ref='bothButton'
                        width={500} height={25} checked={true}>
                        Both
                    </JqxRadioButton>
                </div>
