...
class App extends React.Component {
    ...
    render () {
        ...
        return (
                <div id="ownerPanel" style={{ height: '80%', width: '100%' }}>
                    ...
                    <JqxResponsivePanel ref='myResponsivePanel' style={{ display: 'inline' }}
                      width={'30%'} height={'100%'} collapseBreakpoint={700} autoClose={false}
                      toggleButton={'#toggleResponsivePanel'}  animationType={'none'}
                    >
                        <JqxTree template={treeHTML} width={'35%'} height={'100%'} style={{ float: 'left' }}/>
                    </JqxResponsivePanel>
