...
class App extends React.Component {
    render() {
            ...
            items: [{
                ...
                items: [{
                    ...
                    initContent: () => {
                        ...
                        ReactDOM.render(<JqxTree source={source} width={200} rtl={true}/>, document.getElementById('solutionExplorerTree'));
                    }
                }, {
                    type: 'layoutPanel',
                    title: 'Properties',
        ...
        return (
            <JqxLayout width={800} height={600} layout={layout} rtl={true}>
                <div data-container='ToolboxPanel'>List of tools</div>
                <div data-container='HelpPanel'>Help topics</div>

                <div data-container='Document1Panel'>
                    <div style={{ float: 'right' }}>Document 1 content</div>
                </div>
                <div data-container='Document2Panel'>
                    <div style={{ float: 'right' }}>Document 2 content</div>
                </div>
