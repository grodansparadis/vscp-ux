...
class App extends React.Component {
    componentDidMount() {      
        this.refs.viewServerExplorer.on('click', () => {
                ...
                () => {
                    ...
                    ReactDOM.render(
                        <JqxTree style={{ border: 'none' }}
                            width={190} height={'auto'} source={source} />
                        , document.getElementById('serverExplorerTree'));
                }
            );
            this.refs.viewServerExplorer.disabled(true);
        });
    }
    render() {
        let layout = [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        initContent: () => {
                            let textArea = ReactDOM.render(
                                <JqxTextArea style={{ margin: 5 }}
                        ...
                        initContent: () => {
                            ReactDOM.render(
                                <JqxTextArea style={{ margin: 5 }}
                                    width={'100%'} height={400} placeHolder={'Blank document'} />
                        ...
                        initContent: () => {
                            ...
                            ReactDOM.render(
                                <JqxChart style={{ width: '99%', height: '100%' }}
                                    ...
                                    source={data} xAxis={xAxis} colorScheme={'scheme01'} seriesGroups={seriesGroups} />
            ...
            <div>
                <JqxDockingLayout ref='myDockingLayout'
                    ...
                    <div data-container='Document1Panel'>
                        <div style={{ padding: 5 }} id='Document1TextArea' />
                    </div>
                    <div data-container='Document2Panel'>
                        <div style={{ padding: 5 }} id='Document2TextArea' />
                    </div>
                ...
                <br />
                <JqxButton ref='viewServerExplorer' value='View Server Explorer' />
            </div >
        )
    }
}
