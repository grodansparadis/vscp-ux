...
function createTreeMap(selector)
{
    ...
    //defining options
    var options: jqwidgets.TreeMapOptions = {
        width: 850,
        height: 600,
        source: data,
        colorRange: 50,
        renderCallbacks: {
            '*': function (elementObject, value) {
                if (value.data) {
                        ...
                        var elementinstance: jqwidgets.jqxTooltip = jqwidgets.createInstance(elementObject, 'jqxTooltip', toolTipOptions);
    ...
    // creating instances
    var treemapInstance: jqwidgets.jqxTreeMap = jqwidgets.createInstance(selector,'jqxTreeMap', options);
};