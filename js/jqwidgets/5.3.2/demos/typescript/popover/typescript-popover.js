...
function createPopover(selector, header, button, table, theme) {
    ...
    for (var i = 0; i < firstNames.length; i++) {
        ...
        var table_1 = '<table style="min-width: 150px;"><tr><td style="width: 55px;" rowspan="2">' + img + '</td><td>' + firstNames[i] + " " + lastNames[i] + '</td></tr><tr><td>' + titles[i] + '</td></tr></table>';
        employeesTable.innerHTML += table_1;
    }
...
//# sourceMappingURL=typescript-popover.js.map