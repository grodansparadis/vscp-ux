...
function createTree(selector, secondSelector) {
    // Create jqxExpander
    var expanderOptions: jqwidgets.ExpanderOptions = {
        showArrow: false,
        toggleMode: 'none',
        width: '300px',
        height: '370px' 
    };
    var expander: jqwidgets.jqxExpander = jqwidgets.createInstance(secondSelector, 'jqxExpander', expanderOptions);
    ...
    var options: jqwidgets.TreeOptions = {
        source: source,
        width: '100%',
        height: '100%'
    };
    ...
    // creates an instance
    var myTree: jqwidgets.jqxTree = jqwidgets.createInstance(selector, 'jqxTree', options);
