...
//
// The vscpkey is the same key as set in the general/seurity settings of the
// VSCP server found in /etc/vscp/vscpd.conf  It should always be 32 bytes (64 charcater)
...
var settings = {
    ...
    //url: "wss://192.168.1.9:8884/ws1" // SSL (to be able to use from remote machine)
