...
// Copyright (C) 2012-2013 Ake Hedman, Grodans Paradis AB
...
/////////////////////////////////////////////////////////////////////////////
// vscpws_getDatacodingSensorIndex
//

function vscpws_getDatacodingSensorIndex(data) {
    return data & 7;
}
...
function vscpws_leddigits(count, x, y, name) {
...
function vscpws_buttondigits(x, y, count, name) {
this.count = count;
        var maxvalue = Math.pow(10, count) - 1;
        this.maxvalue = maxvalue;
        this.x = x;
...
function vscpws_buttonblack(x, y, handler, name) {
...
function vscpws_stateButton( url,             // url to VSCP websocket i/f
...
//alert("ENYTER___1");
    ...
    switch ( this.btnType ) { 
        ...
        case 94:
            this.image_up.src = "../lib/widgets/lightbulb/glossy-light-bulb.jpg";
            break;
    ...
    switch ( this.btnType ) {  
        ...
        case 94:
            this.image_down.src = "../lib/widgets/lightbulb/light-bulb-icon.jpg";
            break;
...
vscpws_stateButton.prototype.setMonitorVariable = function(name,interval) 
{
    // First set default parameter
...
//alert("rx");
    ...
    if ("+" == msgitems[0]){        // check for positive reply
       //alert("Rx_POS");
        ...
        if ("READVAR" == msgitems[1] && (2 == msgitems[2])){
       ...
       //alert("Rx_NEG");
        ...
        if (vscpclass == this.receive_vscpclass_on && 
            ...
            //alert("Rx_ON");
            //this.draw();
            //change the source image - to ON indication
        ...
        if (vscpclass == this.receive_vscpclass_off && 
           ...
           //alert("Rx_OFF");
            //this.draw();
            //change the source image - to OFF indication
...
function vscpws_simpleTextEvent( url,           // url to VSCP websocket i/f
...
function vscpws_thermometerCelsius( url,            // url to VSCP websocket i/f
    ...
    if ("+" == msgitems[0]){        // check for positive reply
        ...
        if ((VSCP_CLASS1_MEASUREMENT == this.vscpclass) ||
            ...
            if ((-1 != this.sensorIndex) &&
                    (vscpws_getDatacodingSensorIndex(vscpdata[0]) != this.sensorIndex))
                return;

            // This event is for us
            this.value = vscpws_toFixed(vscpws_measurementClass10Decode(vscpdata), 1);
        ...
        // Floating point
            ...
            this.value = vscpws_toFixed(vscpws_measurementClass60DecodeNumber(vscpdata), 1);
            this.value = vscpws_convertKelvinToCelsius(this.value);
            this.temp = this.value;
            this.draw();
        ...
        // Measurement with zone
            ...
            // Check sensor index
            if ((-1 != this.sensorIndex) &&
                    (vscpws_getDatacodingSensorIndex[vscpdata[3]] != this.sensorIndex))
                return;
...
function vscpws_speedometerCelius( url,         // url to VSCP websocket i/f
                                    canvasName, // Placeholder for widget
                                    widgetType, // Widget type
                                    vscpclass,  // Event class 10/60/65/15
                                    vscptype,   // Event type
...
{	 
    ...
    if ("+" == msgitems[0]){        // check for positive reply
        ...
        if ((VSCP_CLASS1_MEASUREMENT == this.vscpclass) ||
            ...
            // This event is for us 
            this.value = vscpws_toFixed(vscpws_measurementClass10Decode(vscpdata), this.ndecimals);
...
function vscpws_relocate( url,          // url to relocate to
